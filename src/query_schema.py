...
class QueryRepresentation:
    ...
    def __init__(self,raw_query:str,normalized_query:str,query_type:str,country_codes:list[str],region_terms:list[str],
                 industry_terms:list[str],business_model_terms:list[str],target_market_terms:list[str],capability_terms:list[str],relational_terms:list[str],
        ...
        self.capability_terms=capability_terms
    ...
    def to_dict(self):
        return{
            ...
            "capability_terms":self.capability_terms,
